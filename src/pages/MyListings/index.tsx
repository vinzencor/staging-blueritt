...
const SavedProducts: React.FC = () => {
  ...
  const SpkhorizontalSkeleton = () => (
    <div className="grid grid-cols-12 gap-0 animate-pulse bg-white dark:bg-gray-800 p-6 rounded-md">
      <div className="lg:col-span-2 xl:col-span-1 col-span-12">
        <div className="h-20 w-20 md:w-32 bg-gray-300 dark:bg-gray-700 rounded-md"></div>
      </div>
      <div className="lg:col-span-10 xl:col-span-11 col-span-12">
        ...
        <div className="flex items-center justify-center lg:justify-start gap-x-2 px-5 pb-2">
          <div className="px-6 md:px-16 h-10 bg-gray-300 dark:bg-gray-700 rounded-md"></div>
          <div className="px-6 md:px-16 h-10 bg-gray-300 dark:bg-gray-700 rounded-md"></div>
        </div>
      </div>
    </div>
    ...
    <>
      {!showCategoryProducts ? (
        <>
          ...
          />
          <div className="box p-6 rounded-xl shadow-lg bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3 pb-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Product Vault</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">Manage your saved product searches and categories</p>
              </div>
            </div>
            <div className="mt-6">
              {isLoading ? (
                <div className="space-y-4">
                  {Array.from({ length: 3 }).map((_, index) => (
                    <div key={index} className="animate-pulse">
                      <div className="bg-gray-200 dark:bg-gray-700 rounded-lg h-24 w-full"></div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-4">
                  {savedCategoryData.map((category: Category) => (
                    <div key={category.id} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-md transition-all duration-200 overflow-hidden">
                      <div className="p-4">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">Start by saving products from BlueRitt Social Pulse to build your product vault.</p>
        ...
        <>
          ...
          />
          <div className="w-full box p-6 rounded-xl shadow-lg bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <button
                  onClick={handleBackToCategories}
                  className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg transition-colors font-medium"
                >
                  <svg
                    className="h-4 w-4"
                    fill="none"
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white">{formattedCategoryName} Products</h2>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Manage and analyze your saved products</p>
                </div>
              </div>
            </div>
